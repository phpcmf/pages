...
import { slug } from 'cmf/common/utils/string';
...
export default class EditPageModal extends Modal {
  ...
  title() {
    ...
    return title ? title : app.translator.trans('cmf-pages.admin.edit_page.title');
  }
      ...
      <div className="Modal-body">
        <div className="Form">
          <div className="Form-group">
            <label>{app.translator.trans('cmf-pages.admin.edit_page.title_label')}</label>
            <input
              className="FormControl"
              placeholder={app.translator.trans('cmf-pages.admin.edit_page.title_placeholder')}
          ...
          <div className="Form-group">
            <label>{app.translator.trans('cmf-pages.admin.edit_page.slug_label')}</label>
            <input
              className="FormControl"
              placeholder={app.translator.trans('cmf-pages.admin.edit_page.slug_placeholder')}
              value={this.slug()}
              oninput={(e) => {
          ...
          <div className="Form-group">
            <label>{app.translator.trans('cmf-pages.admin.edit_page.content_label')}</label>
            <textarea
              className="FormControl"
              rows="5"
              value={this.pageContent()}
              onchange={withAttr('value', this.pageContent)}
              placeholder={app.translator.trans('cmf-pages.admin.edit_page.content_placeholder')}
            />
          </div>
          ...
          <div className="Form-group">
            <div>
              <label className="checkbox">
                ...
                {app.translator.trans('cmf-pages.admin.edit_page.hidden_label')}
              </label>
            </div>
          </div>
          ...
          <div className="Form-group">
            <div>
              <label className="checkbox">
                ...
                {app.translator.trans('cmf-pages.admin.edit_page.restricted_label')}
              </label>
            </div>
          </div>
          ...
          <div className="Form-group">
            <div>
              <label className="checkbox">
                ...
                {app.translator.trans('cmf-pages.admin.edit_page.html_label')}
              </label>
            </div>
          </div>
          ...
          <div className="Form-group">
            {Button.component(
              ...
              app.translator.trans('cmf-pages.admin.edit_page.submit_button')
            )}
            {this.page.exists ? (
              <button type="button" className="Button EditPageModal-delete" onclick={this.delete.bind(this)}>
                {app.translator.trans('cmf-pages.admin.edit_page.delete_page_button')}
              </button>
            ) : (
              ''
            )}
