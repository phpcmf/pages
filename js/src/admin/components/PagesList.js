...
import Placeholder from 'cmf/common/components/Placeholder';
...
export default class PagesList extends Component {
  ...
  view() {
    ...
    if (this.pages.length === 0) {
      const text = app.translator.trans('cmf-pages.admin.pages_list.empty_text');
    ...
    return (
      <div className="PageList">
        <table className="PageList-results">
          <thead>
            <tr>
              <th>{app.translator.trans('cmf-pages.admin.pages_list.title')}</th>
              <th />
            </tr>
          </thead>
          <tbody>
